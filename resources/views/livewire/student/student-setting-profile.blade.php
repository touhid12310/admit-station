<div>
    <main class="tp-dashboard-body-bg">
        ...
        @include('livewire.partials.layouts-student-banner')
                                                ...
                                                <div class="tp-instructor-wrap d-flex justify-content-between">
                                                    ...
                                                    <div
                                                        ...
                                                        <span class="upload-btn">
                                                            <input id="tpd-setting-cartificate-input" type="file"
                                                                wire:model="cover_photo" accept="image/png, image/jpeg">
                                                            <label for="tpd-setting-cartificate-input"><span><svg
                                                                        width="18" height="16"
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="tpd-input">
                                                            ...
                                                            <input type="text" wire:model="email"
                                                                placeholder="shihab@example.com" disabled>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="tpd-setting-cartificate-content pr-100 pt-15">
                                                        <div class="tpd-input">
                                                            <input class="p-2" type="file"
                                                                wire:model="certificates_img" multiple>
                                                        </div>
                                                    </div>
                                                </div>
