                                    ...
                                    <div class="col-lg-5">
                                        <div class="tp-fact-item d-flex align-items-center justify-content-between">
                                            <div class="tp-fact-content">
                                                <h5>
                                                    @if (!empty($instituteAdded))
                                                        Yes Added
                                                    @else
                                                        Not Added
                                                    @endif
                                                </h5>
                                                <span>Institute added status</span>
                                            </div>
                                            <div class="tp-fact-icon">
                                                <span><img
                                                        src="{{ asset('assets/img/dashboard/icon/fact/teacher.svg') }}"
                                                        alt="fact-icon"></span>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="tp-fact-item d-flex align-items-center justify-content-between">
                                            ...
                                            <div class="tp-fact-icon">
                                                <span class="common-pale-yellow"><img
                                                        src="{{ asset('assets/img/dashboard/icon/fact/enroll-icon.svg') }}"
                                                        alt="fact-icon"></span>
                                            </div>
                                        </div>
                                    </div>
