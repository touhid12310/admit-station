<div>
    ...
    <section class="tp-breadcrumb__area pt-160 pb-150 p-relative z-index-1 fix">
        <div class="tp-breadcrumb__bg" data-background="assets/img/breadcrumb/campus-breadcrumb.jpg"></div>
        <div class="container">
              ...
              <div class="col-sm-12">
                 <div class="tp-breadcrumb__content">
                    <div class="tp-breadcrumb__list inner-after">
                       ...
                       <span class="white">Computer Science</span>
                    </div>
                    <h3 class="tp-breadcrumb__title color">Computer Science</h3>
                 </div>
              </div>
           </div>
        </div>
                 ...
                 <div class="col-lg-3">
                    <div class="tp-course-requrement-widget-box">
                       ...
                       <div class="tp-course-requrement-widget-btn mb-30">
                          ...
                          <a class="tp-btn btn-2 w-100 text-center" href="university-apply.html">Apply Now</a>
                       </div>
                       ...
                       <div class="tp-course-requrement-widget-faq">
                          <h4 class="tp-course-requrement-widget-faq-title">Do you have <br>
                             more questions?</h4>
                          <p>Read our <a href="faq.html">FAQ</a></p>
