            ...
            <div class="row">
                    ...
                    <div class="tp-service-item text-center mb-40 wow fadeInUp" data-wow-delay=".3s">
                        <div class="tp-service-wrap">
                            ...
                            <div class="tp-service-btn">
                                <a href="#"><span><svg width="12" height="12" viewBox="0 0 12 12"
                                            fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="tp-service-item text-center mb-40 wow fadeInUp" data-wow-delay=".5s">
                        ...
                        <div class="tp-service-content">
                            <p>Stay together, no matter where life takes you. Dependents are in safe hands.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="tp-service-item text-center mb-40 wow fadeInUp" data-wow-delay=".7s">
                        ...
                        <div class="tp-service-content">
                            <p>Explore the world with confidence. Your Tourist Visa is our priority.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="tp-about-wrapper mb-60 wow fadeInRight" data-wow-delay=".3s">
                        <div class="tp-section mb-40">
                            ...
                            <h3 class="tp-section-title mb-30">A few words <br> about the
                                <span> Admit Station <svg width="180" height="13" viewBox="0 0 180 13"
                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <p>Admit Station a top consultancy firm in Bangladesh, We&#039;re your one-stop solution,
                                whether you&#039;re searching for a study abroad consultancy firm near Banani or
                                exploring options for studying abroad from Dhaka.</p>
                        </div>
                ...
                <div class="col-lg-8">
                    <div class="tp-event-section text-center mb-60 wow fadeInUp" data-wow-delay=".2s">
                        <div class="tp-section">
                            <h5 class="tp-section-subtitle">UPDATES</h5>
                            <h3 class="tp-section-2-title">Latest
                                <span>
                                    Articles.
