                    ...
                    <div class="col-lg-8">
                        <div class="tp-course-grid-sidebar-left d-flex align-items-center">
                            ...
                            <div class="tp-course-filter-top-result">
                                <p>Showing {{ $vendors->firstItem() }} to {{ $vendors->lastItem() }} of {{ $vendors->total() }} results</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4">
                                        ...
                                        <div class="col-xl-4 col-md-6">
                                            <div class="tp-course-item p-relative fix mb-30">
                                                <div class="tp-course-teacher mb-15">
                                                    <span><img src="{{ $vendor->logo }}" alt="">Hilary Ouse</span>
                                                </div>
                                                ...
                                                <div class="tp-course-btn">
                                                    <a href="{{ route('institute-details', $vendor->id) }}">Preview this Course</a>
                                                </div>
                                            </div>
                                        </div>
                                    @empty
