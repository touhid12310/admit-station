<div>
    ...
    <section class="tp-breadcrumb__area pt-60 pb-60 p-relative z-index-1 fix">
        {{-- <div class="tp-breadcrumb__bg" data-background="assets/images/contact-image.jpg"></div> --}}
        <div class="tp-contact-bg" data-bg-color="#57595F"></div>
        <div class="container">
           <div class="row align-items-center">
              <div class="col-sm-12">
                 <div class="tp-breadcrumb__content">
                    <div class="tp-breadcrumb__list pt-90">
                    ...
                    <h3 class="tp-breadcrumb__title white" style="color: #AB0C2F">Become an Agent</h3>
                 </div>
              </div>
           </div>
        </div>
       ...
       <section class="tp-instructor-area tp-instructor-p">
        <div class="container">
           <div class="row">
              <div class="col-lg-12">
                 <div class="tp-instructor-title-wrap text-center mb-40 wow fadeInUp" data-wow-delay=".3s">
                    <h3 class="tp-instructor-main-title">How to <br> Become an Agent</h3>
                 </div>
                                      ...
                                      <div class="row">
                                         ...
                                         <div class="col-lg-12">
                                            <div class="tp-instructor-apply-input-btn">
                                               <button class="tp-btn-inner" type="submit">Become a Instructor <span><svg xmlns="http://www.w3.org/2000/svg" width="7" height="12" viewBox="0 0 7 12" fill="none">
