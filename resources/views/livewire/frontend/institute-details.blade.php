                    ...
                    <div class="tp-course-details-wrapper">
                        <div class="tp-course-details-heading">
                            ...
                            <div class="tp-course-details-list">
                                <ul>
                                    <li><span><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                                viewBox="0 0 20 20" fill="none">
                                                <rect width="20" height="20" rx="10" fill="#FFDC69" />
                                                <path d="M14 7L8.5 12.5L6 10" stroke="#161613" stroke-width="1.5"
                                            ...
                                            <ul>
                                                ...
                                                <li class="tp-course-table-inner">
                                                    <div class="tp-course-table-row">
                                                        ...
                                                        <div class="tp-course-sub">
                                                            <h4 class="tp-table-inner">Basic Functional English and
                                                                English Spoken</h4>
                                                        </div>
                                                        <div class="tp-course-type">
                                                ...
                                                <li class="tp-course-table-inner">
                                                    <div class="tp-course-table-row">
                                                        ...
                                                        <div class="tp-course-sub">
                                                            <h4 class="tp-table-inner">Programming and Problem Solving
                                                            </h4>
                                                        </div>
                                                        <div class="tp-course-type">
                                            ...
                                            <ul>
                                                ...
                                                <li class="tp-course-table-inner">
                                                    <div class="tp-course-table-row">
                                                        ...
                                                        <div class="tp-course-sub">
                                                            <h4 class="tp-table-inner">Object Oriented Programming Lab
                                                            </h4>
                                                        </div>
                                                        <div class="tp-course-type">
                                                            <h4 class="tp-table-inner">Core Lab</h4>
                                            ...
                                            <ul>
                                                ...
                                                <li class="tp-course-table-inner">
                                                    <div class="tp-course-table-row">
                                                        ...
                                                        <div class="tp-course-sub">
                                                            <h4 class="tp-table-inner">Database Management System Lab
                                                            </h4>
                                                        </div>
                                                        <div class="tp-course-type">
                                                            <h4 class="tp-table-inner">Core Lab</h4>
                            ...
                            <div class="tp-course-details-social">
                                <a href="#"><span><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                ...
                                <a class="black" href="#"><span><svg xmlns="http://www.w3.org/2000/svg"
