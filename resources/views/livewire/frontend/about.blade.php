<div>
                ...
                <div class="col-lg-6">
                    <div class="tp-about-tutor-heading mb-130">
                        <div class="tp-about-tutor-subtitle d-flex align-items-center">
                            ...
                            <p>Know about Education</p>
                        </div>
                        <h3 class="tp-about-tutor-title" style="color: #AB0C2F">Committed to Your Educational Success
                        </h3>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="tp-about-tutor-right d-flex justify-content-lg-end mb-130">
                        <div class="tp-about-tutor-content">
                            <p>We connect you with world-renowned schools and universities, guiding you through
                                admissions, scholarships, and work permits. Our mission is to make quality education
                ...
                <div class="col-lg-8">
                    <div class="tp-our-mission-wrapper wow fadeInUp" data-wow-delay=".5s">
                        <div class="tp-our-mission-heading">
                            <h3 class="tp-our-mission-title" style="color: #AB0C2F">What We Offer</h3>
                            <p>
                                <strong>Admissions:</strong> Get all the information you need about the admission
                                processes of top schools and universities around the world.<br>
                                <strong>Scholarships:</strong> Discover various scholarship opportunities that can
                                make your education more affordable.<br>
                                <strong>Part-Time Work Permits:</strong> Learn about part-time work permits
                                available for students, helping you gain work experience while studying.
                            </p>
                        </div>
                        <div class="tp-our-mission-heading">
                            <h3 class="tp-our-mission-title" style="color: #AB0C2F">Our Goals</h3>
                            <p>Are you looking for admission in a renowned and world’s top-ranked school or university?
                                You've come to the right place! Our platform is your gateway to explore some of the best
                                educational institutions globally.</p>
                        </div>

                        <div class="tp-our-mission-heading">
                            <h3 class="tp-our-mission-title" style="color: #AB0C2F">Why Choose Us?</h3>
                            <p>We provide you with the latest and most accurate information about the dynamic and
                                challenging environments of world-class educational institutions. Whether you're looking
                                for details on admissions, scholarships, or work permits, our website has you covered.
                            </p>

                            <p>Explore our website to learn more and take the first step toward your educational
                                journey!</p>
                        </div>
    ...
    <!-- team-area-start -->
    <section id="team" class="team-area pt-100 mb-100">
        <div class="container">
            <div class="row align-items-end">
                <div class="col-lg-6 col-md-8">
                    <div class="tp-section mb-45">
                        <h5 class="tp-section-3-subtitle" style="color: #AB0C2F">Our Team</h5>
                        <h3 class="tp-section-3-title">Meet Our
                            <span style="color: #AB0C2F">Teams
                                <img class="tp-underline-shape-9 wow bounceIn" data-wow-duration="1.5s"
                                    data-wow-delay=".4s" src="assets/images/unlerline/team-2-svg-1.svg"
                                    alt="">
                            </span>
                        </h3>
                    </div>
