           ...
           <div class="tp-login-register-wrapper d-flex justify-content-center align-items-center">
              <div class="tp-login-from-box pt-5">
                 ...
                 <div class="tp-login-input-form">
                    <div class="row">
                        <form wire:submit.prevent='userRegister' class="mb-3">
                           <div class="col-12">
                           ...
                           <div class="col-12">
                              <div class="tp-login-input p-relative">
                                 <label>Email</label>
                                 <input type="email" wire:model="email" placeholder="Type your email" autofocus autocomplete="email" >
                              </div>
                              @error('email')
                                 <div class="m-2 text-danger">{{ $message }}</div>
                              @enderror
                           ...
                           <div class="col-12">
                              <div class="tp-login-input p-relative">
                                 <label>Phone</label>
                                 <input type="text" wire:model="phone_no" placeholder="Type your phone number" autofocus autocomplete="phone_no" >
                              </div>
                              @error('phone_no')
                                 <div class="m-2 text-danger">{{ $message }}</div>
                              @enderror
                           ...
                           <div class="col-12">
                              <div class="tp-login-input p-relative">
                                 ...
                                 <div class="password-input p-relative">
                                    <input type="password"  wire:model="confirmed_password" placeholder="Password">
                                    <div class="tp-login-input-eye password-show-toggle">
                                       <span class="open-eye open-eye-icon">
                                          <svg width="18" height="14" viewBox="0 0 18 14" fill="none" >
                                             <path d="M1 6.77778C1 6.77778 3.90909 1 9 1C14.0909 1 17 6.77778 17 6.77778C17 6.77778 14.0909 12.5556 9 12.5556C3.90909 12.5556 1 6.77778 1 6.77778Z" stroke="currentColor" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"/>
