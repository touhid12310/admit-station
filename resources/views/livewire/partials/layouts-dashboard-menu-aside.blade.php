        ...
        <div class="tp-user-wrap">
            <div class="tp-user-menu ">
                <nav>
                    ...
                    <li>
                        <a class="active" href="{{ route('student-dashboard')}}" wire:navigate
                            x-bind:class="$current('/student-dashboard') ? 'active' : ''">
                            <span>
                    ...
                    <li>
                        <a href="{{ route('student-profile')}}" wire:navigate x-bind:class="$current('/student-profile') ? 'active' : ''">
                            <span>
                    ...
                    <li>
                        <a href="{{route('student-setting-profile')}}">
                            <span>
                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
