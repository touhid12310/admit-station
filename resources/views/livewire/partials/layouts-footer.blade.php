                 ...
                 <div class="col-xl-6 col-lg-6 col-sm-6">
                    <div class="tp-footer-widget tp-footer-col-1 mb-30">
                       ...
                       <div class="tp-footer-contact">
                          ...
                          <a href="tel:012345678">+880 1839-440444</a>
                       </div>
                    ...
                    <div class="p-footer-widget tp-footer-col-4 mb-30">
                       ...
                       <div class="tp-footer-newsletter-wrap">
                          ...
                          <div class="tp-footer-newsletter-social">
                             <a class="social-fb" href="https://www.facebook.com/people/Admit-Station/61563570187566/" target="_blank"><i class="fa-brands fa-facebook-f"></i></a>
                             <a class="social-twit" href="https://x.com/admitstation24" target="_blank"><i class="fa-brands fa-x"></i></a>
                             <a class="social-lnkd" href="#"><i class="fa-brands fa-linkedin-in" target="_blank"></i></a>
                             <a class="social-yout" href="https://www.instagram.com/admitstation24/" target="_blank"><i class="fa-brands fa-instagram"></i></a>
                          </div>
                       </div>
                    </div>
                 </div>
              ...
              <div class="row">
                 <div class="col-lg-12">
                    <div class="tp-footer-copyright text-center">
                       <span>© {{ date('Y') }} <a href="{{url('/')}}" wire:navigate>Admit Station </a>. All rights reserved.</span>
                    </div>
                 </div>
              </div>
           </div>
