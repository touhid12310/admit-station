<div>
    ...
    <header class="header-area p-relative">
      <div id="header-sticky" class="tp-header-2">
         <div class="container custom-container-larg p-2">
            <div class="row d-flex justify-content-between">
                ...
                <div class="col-xxl-3 col-xl-2 col-lg-6 col-6">
                   <div class="tp-header-2-contact d-flex align-items-center justify-content-end">
                      ...
                      <div class="tp-header-user-hover">
                         <button ><img src="{{ asset('assets/images/dashboard-profile-2.jpg') }}" alt="" class="rounded-circle mt-2 mb-2" style="width: 25%"></button>
                         <div class="tp-header-user-box mt-1">
